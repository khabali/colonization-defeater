...
public class Level1GameState extends GameStateAdapter {
	...
	public void init() {
		...
		MyGdxGame.world.setSystem(new CameraSystem(xMax, yMax));
		...
		// --
		MyGdxGame.world.setManager(new TagManager());
		MyGdxGame.world.setSystem(new MapRenderSystem(tiledMap, fixedBackground, backgrounds));
		MyGdxGame.world.setSystem(new PlayerControlSystem());
		MyGdxGame.world.setSystem(new BulletSystem());
		MyGdxGame.world.setSystem(new SpriteRenderSystem());
		MyGdxGame.world.setSystem(new Box2dDebugRenderSystem());
		MyGdxGame.world.initialize();

		EntityFactory.createGround(MyGdxGame.world, tiledMap);
		EntityFactory.createPlayer(MyGdxGame.world, tiledMap);
	}
	...
	@Override
	public void draw() {
		MyGdxGame.world.process(Gdx.graphics.getDeltaTime());
	}
